Pod::Spec.new do |s|
    ...
    s.source                = { :git => "https://github.com/poulpix/PXGoogleDirections.git", :tag => "1.2.4" }
    s.requires_arc          = true
    ...
    s.ios.resource_bundle   = { 'GoogleMaps' => 'Pods/GoogleMaps/Frameworks/GoogleMaps.framework/Resources/*.bundle' }
